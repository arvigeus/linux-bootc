...
_fs_parse_args() {
	...
	cp)
		vshort="tS"
		vlong="target-directory|suffix|backup|sparse|reflink"
		;;
	mv)
		vshort="tS"
		vlong="target-directory|suffix|backup"
		;;
	rm)
		vshort=""
		vlong=""
	...
	install)
		vshort="tmogSZ"
		vlong="target-directory|mode|owner|group|suffix|backup|context"
		;;
	ln)
		vshort="tS"
		vlong="target-directory|suffix|backup"
